<?php
/**
 * Homepage hero: the converging-network globe, and the proof bar nested in it.
 *
 * THE PROOF BAR IS A CHILD OF THIS SECTION, NOT A SIBLING. That is how the
 * static page is built, and it is the reason this file is large. It was
 * extracted separately once, which rendered the sponsor row twice on the
 * homepage; removing the nested copy then truncated this file mid-section and
 * left the <section> unclosed, which nested the entire rest of the homepage
 * inside the hero and stopped the globe rendering. Do not split them.
 *
 * HARDCODED ON PURPOSE, and it must never become an ACF field: the SVG is
 * machine-generated and carries data-globe-* attributes that globe.js rewrites
 * at runtime. Behind a WYSIWYG, the first editor save strips them through
 * wp_kses and the globe silently stops animating.
 *
 * If this file is ever re-extracted: count section tags on a COMMENT-FREE copy
 * and slice the original. The comments contain the literal string "<section".
 *
 * @package convergx
 */
  ...
  <section class="proofbar-band" aria-labelledby="hero-sponsors-h">
      ...
      <div class="sponsor-reel-track">
        <ul class="sponsor-set">
          ...
          <li><span class="mark" style="--mark-src: url('<?php echo esc_url( CONVERGX_URI ); ?>/assets/sponsors/boeing.png?v=1'); --mark-ratio: 3.983; --mark-cap-frac: 0.700;" role="img" aria-label="Boeing"></span></li>
          ...
          <li><span class="mark" style="--mark-src: url('<?php echo esc_url( CONVERGX_URI ); ?>/assets/sponsors/dnd.png?v=4'); --mark-ratio: 6.072; --mark-cap-frac: 0.700;" role="img" aria-label="Department of National Defence"></span></li>
