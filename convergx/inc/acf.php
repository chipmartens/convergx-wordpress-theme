	...
	acf_add_local_field_group(
		array(
			...
			'fields'   => array(
				...
				array(
					'key'           => 'field_convergx_hero_class',
					'label'         => 'Headline scale',
					'name'          => 'hero_class',
					'type'          => 'select',
					'choices'       => array(
						''                          => 'Standard',
						'display--hero'             => 'Hero scale',
						'display--hero hero-title'  => 'Hero scale, photographic hero',
					),
					'default_value' => '',
					'allow_null'    => 1,
					'return_format' => 'value',
					'instructions'  => 'Standard is the common case and the right default. Hero scale is for pages whose headline is the whole of the first screen. Setting it everywhere is not a style choice: it roughly doubles the headline and pushes everything below it down the page.',
				),
				array(
			...
			'fields'   => array(
				array(
					...
					'layouts'      => array(
						'editorial' => array(
							...
							'sub_fields' => array(
								...
								array(
									...
									'allow_null'    => 1,
									'return_format' => 'value',
									'instructions'  => 'Sets this section on its own colour ground. Navy band is the brand accent ground, used sparingly: one section on the site uses it today. which is how the pages break a long run into bands rather than one continuous field of colour. Leave on Inherit unless you are deliberately starting a new band. Every colour in the section resolves against this, so changing it re-colours the type, rules and buttons together rather than leaving one of them behind.',
								),
							),
						),
						'figure' => array(
						...
						'exact' => array(
							'key'        => 'layout_convergx_exact',
							'name'       => 'exact',
							'label'      => 'Section (exact HTML)',
							'display'    => 'block',
							'sub_fields' => array(
								array(
									'key'          => 'field_cx_exact_surface',
									'label'        => 'Colour band',
									'name'         => 'surface',
									'type'         => 'select',
								...
								array(
									...
									'type'         => 'textarea',
									'rows'         => 18,
									'instructions' => 'The section\'s complete outer HTML, exactly as it renders. {{ASSETS}} resolves to the theme\'s assets URL and {{FORM:key}} renders that native form in place. Seeded verbatim from the launch site; edit with care, since nothing here is corrected on save.',
								),
							),
						),
						'part' => array(
							'key'        => 'layout_convergx_part',
							'name'       => 'part',
							'label'      => 'Built-in section',
							'display'    => 'block',
							'sub_fields' => array(
								array(
									'key'          => 'field_cx_part_surface',
									'label'        => 'Colour band',
									'name'         => 'surface',
									'type'         => 'select',
									'choices'      => array( '' => 'None (page ground)', 'light' => 'Light', 'dark' => 'Dark', 'muted' => 'Muted', 'navy' => 'Navy' ),
								...
								array(
									...
									'type'         => 'select',
									'choices'      => array(
										'speakers' => 'Speakers (from the Speakers screen)',
										'agenda'   => 'Agenda',
										'hotels'   => 'Accommodations',
										'sponsors' => 'Sponsors',
										'team'     => 'Leadership team (from the Team screen)',
										'flow'     => 'Flow diagram',
									),
									'return_format' => 'value',
									'instructions' => 'Places a theme-rendered section at this point in the page. Its content is edited on its own screen (Speakers, Team, the Congress page fields), not here.',
								),
							),
						),
						'cta' => array(
